...
public class ClassEvalCriteriaServiceImpl implements ClassEvalCriteriaService{
    ...
    @Override
    public List<ClassEvalCriteria> List(String search, String mId , String assId , String status, int currentPageNo, int PageSize) {
        Connection connection = null;
        List<ClassEvalCriteria> evalCriterias = null;
        try {
            connection = BaseDao.getConnection();

            evalCriterias = evalDao.findAll(connection ,currentPageNo, PageSize , search, mId , assId, status);
